...
file<-c("C:/Users/joeja/Desktop/EducationalResources/functionansFromJN.Rmd","C:/Users/joeja/Desktop/EducationalResources/withPlotFromJup.Rmd","C:/Users/joeja/Desktop/EducationalResources/fruit2FromJupyter.Rmd","C:/Users/joeja/Desktop/EducationalResources/canvasquizFromJN.Rmd")
dir="C:/Users/joeja/Desktop/EducationalResources"
tdir=NULL
name="Test"
maxattempts=1
duration=15
...
#######################################################################################################################################
  ...
  ## compress
  ##adding library(zip) fixed the function for me
  library(zip)
  if(zip) {
    owd <- getwd()
    setwd(test_dir)
